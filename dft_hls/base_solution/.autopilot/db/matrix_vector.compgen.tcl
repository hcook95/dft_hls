...
set id 2
set name matrix_vector_facc_32ns_32ns_1ns_32_6_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename M \
    op interface \
    ports { M_address0 { O 6 vector } M_ce0 { O 1 bit } M_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename V_In \
    op interface \
    ports { V_In_address0 { O 3 vector } V_In_ce0 { O 1 bit } V_In_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'V_In'"
}
}
