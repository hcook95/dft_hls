...
__attribute__((sdx_kernel("matrix_vector", 0))) void matrix_vector(BaseType M[8][8], BaseType V_In[8], BaseType V_Out[8]);
# 3 "simple_dft.cpp" 2

__attribute__((sdx_kernel("matrix_vector", 0))) void matrix_vector(BaseType M[8][8], BaseType V_In[8], BaseType V_Out[8])
{_ssdm_SpecArrayDimSize(M, 8);_ssdm_SpecArrayDimSize(V_In, 8);_ssdm_SpecArrayDimSize(V_Out, 8);
#pragma HLS ARRAY_PARTITION variable=M cyclic factor=2 dim=2
# 5 "simple_dft.cpp"

#pragma HLS ARRAY_PARTITION variable=V_In cyclic factor=2 dim=1
# 5 "simple_dft.cpp"

#pragma HLS TOP name=matrix_vector
# 5 "simple_dft.cpp"
